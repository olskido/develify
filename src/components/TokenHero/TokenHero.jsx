export default function TokenHero({ ticker, currentCap, athTarget, imageUrl }) {
  return (
    <section className="relative min-h-[220px] overflow-hidden sm:min-h-[280px] lg:min-h-[320px] flex items-center justify-center bg-[#0d0e12]">
      <div className="absolute inset-0 z-0">
        <img
          src={imageUrl}
          alt={`${ticker} Hero`}
          className="w-full h-full object-contain object-center opacity-50 block"
        />
      </div>
